  ...
  return (
    <SafeAreaView className="flex-1 bg-background">
      ...
      <View className="px-5 pt-4 pb-6 border-b border-border-light">
        <Typography variant="h2">Appunti</Typography>
        <Typography variant="body" color="secondary" className="mt-1">Note libere e checklist</Typography>
      </View>

      <EmptyState
        icon="create-outline"
        title="Nessun appunto"
        description="Prendi nota di consigli, ristoranti da provare o idee per il viaggio."
        actionLabel="Nuova nota"
