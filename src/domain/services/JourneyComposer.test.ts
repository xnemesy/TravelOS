    ...
    const accommodations: Accommodation[] = [
      {
        ...
        type: 'hotel',
        name: 'Hotel Roma',
        checkIn: unsafeAsInstantISO('2026-08-01T16:00:00.000Z'),
    ...
    const transports: Transport[] = [
      {
        ...
        destination: 'Milano',
        origin: 'Roma',
        departureDate: unsafeAsInstantISO('2026-08-05T14:00:00.000Z'),
        arrivalDate: unsafeAsInstantISO('2026-08-05T15:30:00.000Z'),
        confirmed: true,
      } as Transport,
    ];
    const accommodations: Accommodation[] = [
    ...
    const transports: Transport[] = [
      {
        ...
        destination: 'Milano',
        origin: 'Roma',
        departureDate: unsafeAsInstantISO('2026-08-05T16:00:00.000Z'),
        arrivalDate: unsafeAsInstantISO('2026-08-05T17:30:00.000Z'),
        confirmed: true,
      } as Transport,
    ];
    const anchors = JourneyAnchorEngine.buildTripAnchors(transports, accommodations);
    ...
    const transports: Transport[] = [
      {
        ...
        destination: 'Roma',
        origin: 'Milano',
        departureDate: unsafeAsInstantISO('2026-08-01T22:00:00.000Z'),
        arrivalDate: unsafeAsInstantISO('2026-08-01T23:30:00.000Z'),
        confirmed: true,
      } as Transport,
    ];
    const anchors = JourneyAnchorEngine.buildTripAnchors(transports, accommodations);
